...
| `src/EyeTracker/` | WinForms eye tracker (`EyeTrackerOnWindows`) — `net481` + `net8.0-windows` |
...
- **Windows eye tracker** (`src/EyeTracker/`): multi-targets **.NET Framework 4.8.1** (`net481`) and **.NET 8** (`net8.0-windows`), WinForms + Emgu.CV 4.9
- Xamarin.Android + OpenCV / Google Vision (mobile projects; unchanged archive stack)
- Haar cascades for face and eye detection

## Build (Windows eye tracker)

From a Windows machine with the [.NET 8 SDK](https://dotnet.microsoft.com/download/dotnet/8.0) (and optionally the [.NET Framework 4.8.1 Developer Pack](https://dotnet.microsoft.com/download/dotnet-framework/net481)):
...
dotnet run --project src/EyeTracker/EyeTrackerOnWindows.csproj -f net8.0-windows
```
